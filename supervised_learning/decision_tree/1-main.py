...
def example_0():
    ...
    root = Node(feature=0, threshold=.5,
                left_child=leaf0, right_child=internal_node,
...
print("Number of leaves in example 0 :", example_0().count_nodes(
    only_leaves=True))
print("Number of nodes  in example 1 :", example_1(4).count_nodes())
print("Number of leaves in example 1 :", example_1(4).count_nodes(
    only_leaves=True))
